...
namespace Microsoft.PowerToys.Settings.UI.Library
{
    ...
    {
        public static readonly HotkeySettings DefaultReparentHotkeyValue = new HotkeySettings(true, true, false, true, 0x52, "0", CropAndLockSettings.ModuleName); // Ctrl+Win+Shift+R
        public static readonly HotkeySettings DefaultThumbnailHotkeyValue = new HotkeySettings(true, true, false, true, 0x54, "1", CropAndLockSettings.ModuleName); // Ctrl+Win+Shift+T
