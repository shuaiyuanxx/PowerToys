...
namespace Microsoft.PowerToys.Settings.UI.Library
{
    public class CmdPalProperties
    {
        ...
        public static readonly HotkeySettings DefaultHotkeyValue = new HotkeySettings(true, false, true, false, 32, 0, "CmdPal");
        ...
        public void InitializeHotkey()
        {
            try
            {
                ...
                if (doc.RootElement.TryGetProperty(nameof(Hotkey), out JsonElement hotkeyElement))
                {
                    ...
                    if (Hotkey.HotkeyID == -1)
                    {
                        Hotkey.HotkeyID = DefaultHotkeyValue.HotkeyID;
