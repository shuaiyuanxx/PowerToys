...
namespace Microsoft.PowerToys.Settings.UI.Library
{
    public class ZoomItProperties
    {
        ...
        [CmdConfigureIgnore]
        public static HotkeySettings DefaultToggleKey => new HotkeySettings(false, true, false, false, '1', 0, ZoomItSettings.ModuleName); // Ctrl+1

        [CmdConfigureIgnore]
        public static HotkeySettings DefaultLiveZoomToggleKey => new HotkeySettings(false, true, false, false, '4', 1, ZoomItSettings.ModuleName); // Ctrl+4

        [CmdConfigureIgnore]
        public static HotkeySettings DefaultDrawToggleKey => new HotkeySettings(false, true, false, false, '2', 2, ZoomItSettings.ModuleName); // Ctrl+2

        [CmdConfigureIgnore]
        public static HotkeySettings DefaultRecordToggleKey => new HotkeySettings(false, true, false, false, '5', 3, ZoomItSettings.ModuleName); // Ctrl+5

        [CmdConfigureIgnore]
        public static HotkeySettings DefaultSnipToggleKey => new HotkeySettings(false, true, false, false, '6', 4, ZoomItSettings.ModuleName); // Ctrl+6

        [CmdConfigureIgnore]
        public static HotkeySettings DefaultBreakTimerKey => new HotkeySettings(false, true, false, false, '3', 5, ZoomItSettings.ModuleName); // Ctrl+3

        [CmdConfigureIgnore]
        public static HotkeySettings DefaultDemoTypeToggleKey => new HotkeySettings(false, true, false, false, '7', 6, ZoomItSettings.ModuleName); // Ctrl+7
