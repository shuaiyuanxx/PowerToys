...
namespace Microsoft.PowerToys.Settings.UI.Library
{
    public class PowerLauncherProperties
    {
        ...
        [CmdConfigureIgnoreAttribute]
        public HotkeySettings DefaultOpenFileLocation => new HotkeySettings(-1, PowerLauncherSettings.ModuleName);

        [CmdConfigureIgnoreAttribute]
        public HotkeySettings DefaultCopyPathLocation => new HotkeySettings(-1, PowerLauncherSettings.ModuleName);
        ...
        public PowerLauncherProperties()
        {
            ...
            OpenConsole = new HotkeySettings(-1, PowerLauncherSettings.ModuleName);
